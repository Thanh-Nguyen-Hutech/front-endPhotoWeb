...
import { Users, FileText, BarChart3, ShieldAlert, LogOut, LayoutDashboard, Key } from 'lucide-react'; // 🌟 Đã thêm icon Key
    ...
    <div className="flex min-h-screen bg-[#050A15] text-white font-sans overflow-hidden">
      ...
      <aside className="w-72 border-r border-white/5 bg-[#0F172A]/50 backdrop-blur-xl p-8 flex flex-col shadow-[20px_0_50px_rgba(0,0,0,0.3)]">
        ...
        <nav className="space-y-3 flex-1">
          ...
          {/* 🌟 ĐÃ THÊM: Mục quản lý yêu cầu cấp lại mật khẩu ngay dưới mục Người dùng */}
          <AdminLink icon={<Key size={20}/>} label="Cấp lại mật khẩu" path="/admin/resets" />
